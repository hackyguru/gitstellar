...
export default function Home() {
  ...
  const colors = ["#D4FB84", "#D4FB84", "#D4FB84"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <main className="noise">
            ...
            <div className="flex justify-between items-center p-5">
              ...
              <button className="inline-flex p-3 items-center justify-center rounded-md border border-white border-opacity-50 bg-[length:200%_100%] px-6 font-medium text-white text-opacity-50 transition-colors focus:outline-none focus:ring-2 focus:ring-[#D4FB84] focus:ring-offset-2 focus:ring-offset-[#D4FB84]">
                Dashboard
              </button>
            </div>
            <div className="h-96 mt-5 z-10">
              <World data={sampleArcs} globeConfig={globeConfig} />
            </div>
            <h1 className=" text-[#D4FB84] title text-9xl text-center">
            Stellar and unstoppable <br />
              code collaboration</h1>
            <h3 className="desc text-center mt-4 text-2xl opacity-50">censorship resistant ∙ cost efficient ∙ privacy preserving</h3>
